...
{
    [TestFixture]
    public class NServiceBusMessageForwarderIntegrationTests
    {
        ...
        public void Setup()
        {
            ...
            forwarder = new NServiceBusMessageForwarder("DestinationQueue", endpointFake, message => typeof(TestMessage), new AzureServiceBusForwarder.Serializers.JsonSerializer());
        }
